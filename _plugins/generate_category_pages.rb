        ...
        if pager['previous_page'] || pager['next_page']
            ...
            if pager['previous_page']
                ...
                if pager['previous_page'] == 1
                    html << "<div id=\"newer\" class=\"pager right\"><a href=\"/#{pager['category']}/\" class=\"right\">newer &raquo;</a></div>"
                else
                    html << "<div id=\"newer\" class=\"pager right\"><a href=\"/#{pager['category']}/page#{pager['previous_page']}\" class=\"right\">newer &raquo;</a></div>"
                end

            end

            html << "<div id=\"older\" class=\"pager left\">"
            if pager['next_page']
                html << "<a href=\"/#{pager['category']}/page#{pager['next_page']}\" class=\"left\">&laquo; older</a>"
            end
